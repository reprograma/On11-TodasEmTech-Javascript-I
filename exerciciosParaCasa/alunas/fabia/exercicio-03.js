...
- 3 *Execute as seguintes tarefas: 
    - Declare uma nova variável chamada 'calculadora', e adicione uma instrução somando os valores 10 e 5.*
...
calculadora = ++calculadora; // calculadora = calculadora + 1
console.log(calculadora);

calculadora *= 3;
console.log(calculadora); // calculadora = calculadora * 3
